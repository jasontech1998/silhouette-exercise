  ...
  return (
    <section className="relative mx-auto w-full max-w-6xl overflow-hidden rounded-xl shadow-2xl shadow-[#366A79]/70">
      ...
      <div className="relative z-20 mb-20 p-8 sm:p-14 lg:p-24">
        <div className="">
          <blockquote className="relative max-w-xl text-xl leading-relaxed tracking-tight text-gray-900 md:text-2xl lg:text-3xl">
            <p className="before:absolute before:top-0 before:right-full before:content-['“'] after:text-gray-900/70 after:content-['”']">
              <strong className="font-semibold">
                Silhouette transformed our living environment capabilities.
              </strong>{" "}
              <span className="text-gray-900/70">
                Their ambient intelligence network adapts to our needs in
                real-time, adjusting lighting, climate, and security systems
                with unprecedented subtlety and efficiency.
              </span>
            </p>
          </blockquote>
        </div>
        <div className="mt-14 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
          ...
          <div>
            ...
            <div className="text-sm text-gray-500">
              Director of Smart Building Technologies
            </div>
          </div>
        </div>
      </div>
